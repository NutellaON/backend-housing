...
namespace REST_API.Data
{
    public class DataContext : DbContext
    {
        ...
        public DbSet<Dzīvoklis> Dzīvokļi { get; set; }
        public DbSet<Iedzīvotājs> Iedzīvotāji { get; set; }
        
        public DbSet<IedzīvotājiDzīvokļi> IedzīvotājiDzīvokļi { get; set; }
        public DbSet<Māja> Mājas { get; set; }


        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<IedzīvotājiDzīvokļi>()
                .HasKey(id => new { id.IedzivotajaID, id.DzivoklaID });
            modelBuilder.Entity<IedzīvotājiDzīvokļi>()
                .HasOne(d => d.Dzīvoklis)
                .WithMany(id => id.IedzīvotājiDzīvokļi)
                .HasForeignKey(d => d.DzivoklaID);
            modelBuilder.Entity<IedzīvotājiDzīvokļi>()
                .HasOne(i => i.Iedzīvotājs)
                .WithMany(id => id.IedzīvotājiDzīvokļi)
                .HasForeignKey(i => i.IedzivotajaID);

            //modelBuilder.Entity<Māja>().HasData(
            ...
            //modelBuilder.Entity<Dzīvoklis>().HasData(
            ...
            //modelBuilder.Entity<Iedzīvotājs>().HasData(
            ...
            //modelBuilder.Entity<IedzīvotājiDzīvokļi>().HasData(
